...
from settings import RESPONSE_CODE, SECRET_KEY, APP_ID, GRANT_TYPE, REDIRECT_URL, AUTH_TOKEN


class GetPass(object):
    def __init__(self, auth_token=None) -> None:
        self.response_type = RESPONSE_CODE
    ...
    def call(self):
        ...
        status, response = self.generate_access_token()
